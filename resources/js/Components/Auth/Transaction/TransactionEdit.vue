...
<template>
  <div class="modal-overlay transaction" :class="{ active: props.isEditModal }" @click="closeModal">
    <div class="modal-scroll">
      <div class="modal__wrapper">
        <div class="modal" @click.stop>
          <div class="modal_hide-line" v-touch:swipe.bottom="closeModal"></div>
          <div class="content">    
            <EditForm v-if="isEditModal" :item=props.item :closeModal=props.closeModal />
          </div>
          <!-- START hidden -->
